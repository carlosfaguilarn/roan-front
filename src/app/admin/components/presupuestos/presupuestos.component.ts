...
export class PresupuestosComponent implements OnInit {
  ...
  constructor() { 
    ...
    this.proyectos = [
			{id: '1', titulo:"Portal de hierro", descripcion:'Construcción y remodelación de casa de Rubén', tipo:'Plafón y techos falsos', cliente:'Israel Romero', ubicacion:"Campo 35", trabajadores:"Jose"},
			{id: '2', titulo:"Show Run", descripcion:'Instalación de Deck en la empresa Masterdeck', tipo:'Plafón y techos falsos', cliente:'Israel Romero', ubicacion:"Campo 35", trabajadores:"Jose"},
			{id: '3', titulo:"Woolworth", descripcion:'Remodelación interna en Woolworth', tipo:'Plafón y techos falsos', cliente:'Israel Romero', ubicacion:"Campo 35", trabajadores:"Jose"},
			{id: '4', titulo:"Cenaduría Emma", descripcion:'Construcción de un local para la cenaduría', tipo:'Plafón y techos falsos', cliente:'Israel Romero', ubicacion:"Campo 35", trabajadores:"Jose"}
		];
  }
              ...
              <table border="0" cellspacing="0" cellpadding="0">
                <thead>
                  <tr>
                    ...
                    <th class="unit">Costo unitario</th>
